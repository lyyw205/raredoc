 ...
 *   2) 안전한 RegionCard 삭제 → 자식 0 + 의존행 0 인 Card 삭제 → Set 레코드 삭제.
 *   멱등: 이미 없으면 0건 처리.
 *
 * 실행:
...
async function main() {
  ...
  console.log(`  대상 Card: ${lcIds.length}`);
